...
config :bookmarks, Facebook,
  client_id:     System.get_env("BOOKMARKS_FACEBOOK_CLIENT_ID"),
  client_secret: System.get_env("BOOKMARKS_FACEBOOK_CLIENT_SECRET"),
  redirect_uri:  System.get_env("BOOKMARKS_FACEBOOK_REDIRECT_URI")
